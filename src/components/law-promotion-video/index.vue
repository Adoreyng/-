  ...
  <div class="law-promotion">
    ...
    >
      <div class="panl-content">
        <div id="gallery" class="swiper-container" style="margin-bottom: 14px;">
          ...
          <div class="swiper-button-prev-law swiper-button-white"></div>
          <div class="swiper-button-next-law swiper-button-white"></div>
        </div>
...
export default {
  ...
  methods: {
    setSwiper() {
      let this_ = this;
      this.swipers = new Swiper("#gallery", {
        // 自动播放
        autoplay: {
          delay: 3000,
...
.law-promotion {
  ...
  .swiper-slide-top {
    ...
    .video-btn {
      ...
      z-index: 2;
      cursor: pointer;
      // animation: btnsc 2000ms both infinite;
      img {
        transition: all 0.5s;
        display: block;
        width: 100%;
